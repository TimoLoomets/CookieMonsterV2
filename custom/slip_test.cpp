...
CookieMonsterDrive::SlipController controller{{{7, 25, 8, 24}, {2, 3, 1}, {5, 4, -1}}
...
int main()
{
    ...
    const long test_duration_millis = 1000;
    int test_count = 0;
    while(1)
    {
        Serial.print("Tests: ");
        ...
        controller.rear_controller.M1_controller.target_speed = 0.5;
        controller.rear_controller.M2_controller.target_speed = 0.5;
        ...
        while(current_time - test_start < test_duration_millis)
        {
            ...
            controller.rear_controller.update(current_time);
